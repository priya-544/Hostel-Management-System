	...
	<h1>Reset Password</h1>
			<form  method="post" action="forgetpass_connection.php">
				<div class="control">
					<b><label for="name" style="font-size: 20px; ">
						<span class="glyphicon glyphicon-envelope " ></span>  Email</label></b>
			...
			<div class="control">
					<b><label for="name" style="font-size: 20px; ">
						...
						<span class="eye" onclick="MyFunction()" style="padding-left: 100px;">
				...
				<div class="control">
					<b><label for="name" style="font-size: 20px; ">
						<span class="glyphicon glyphicon-lock " ></span> Comfirm Password 
							<span class="eye" onclick="MyFunction1()" style="padding-left: 60px;">
