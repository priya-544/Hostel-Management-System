...
<div class="form-container">
	<h1>Login Form</h1>
			<form  method="post" action="login_connection.php">
				<div class="control">
					<b><label for="name" style="font-size: 20px; ">
						<span class="glyphicon glyphicon-user " ></span> Email</label></b>
				...
				<div class="control">
					...
					<span class="eye" onclick="MyFunction()" style="padding-left: 140px;">
					<i id="hide2" class="glyphicon glyphicon-eye-close "></i>
					<i id ="hide1" class="glyphicon glyphicon-eye-open "></i>
					</span>
					</label></b>
					<input type="password" name="psw" id="psw" autocomplete="off"  maxlength="8" minlength="8"  title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters"   required>
				</div>
				<div class="link" >
				<a href="forget_password.php" style=" color: orange;padding-right: 150px;">Forgot Password ?</a>
			</div>
				<div class="control">
			...
			<div class="link" >
				Don't have Account?
				<b><a href="register.php">SignUp</a></b>
