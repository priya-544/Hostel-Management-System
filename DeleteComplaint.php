 ...
 <div class="container-fluid">
  ...
  <div class="navbar-right">
    <div class="collapse navbar-collapse " id="myNavbar">
        ...
        <li> <a href ="admin_pending.php" id="text" class="nav-link navbar-brand" ><span class="glyphicon glyphicon-circle-arrow-left "></span></a></li>
        </ul>
    </div>
  </div>
 </div>
...
<center>
		...
		<h1> Are you sure to delete pending complaint?</h1>
		...
		if(mysqli_query($con,$delete))
			{
				...
				<script>
				alert('Pending complaint deleted!!');
