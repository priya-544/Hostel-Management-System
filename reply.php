...
Enter your reply:<input style="padding-bottom: 10px;" type="text" name="reply" autocomplete="off">
<br>
...
$host="localhost";
	...
	if (isset($_POST['ok']))
	{
		$r = filter_input(INPUT_POST ,'reply');
		$sql ="INSERT INTO reply (id,reply,room,date) values ('$id','$r','$room','$date') ";
		if(mysqli_query($con,$sql))
			{
		

		$pending = "INSERT INTO pending (id,date,room,name,type,description) values ('$id','$date','$room','$name','$type','$description') ";
		if(mysqli_query($con,$pending))
			{
